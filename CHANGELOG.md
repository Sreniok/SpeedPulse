...
- Prevented the scheduler service from crashing while logging weekly or monthly report next-run metadata
- Restored scheduled scan execution by allowing the scheduler process to finish startup cleanly
- Added focused regression coverage for scheduler next-run formatting
## [v1.2.0] - 2026-03-30
